...
#(including str boundary to assess areas needed)
...
# note: the revised kadamane .json contains updated requests from NCF for Anamalais (pick only the 4th row as the rest contains older information)
kadamane <- st_read("data/spatial/western_ghats.json") %>%
  st_zm(., drop = TRUE, what = "ZM") %>%
  st_make_valid()
